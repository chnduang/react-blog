# 说说 RealDOM和VirtualDOM的区别？优缺点？

> [https://mp.weixin.qq.com/s/0S0Bczo6_iffx3hNVibJwg](https://mp.weixin.qq.com/s/0S0Bczo6_iffx3hNVibJwg)

![图片](https://mmbiz.qpic.cn/mmbiz_png/gH31uF9VIibQJxwib7BzC5KAqBOP9eibM8l2JmUHyyhns54bK2cLwO7jmC9lB98BB8y0pchlcZJaJzpJoE1AsPUtw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

## 一、是什么

Real DOM，真实`DOM`， 意思为文档对象模型，是一个结构化文本的抽象，在页面渲染出的每一个结点都是一个真实`DOM`结构，如下：

![图片](https://mmbiz.qpic.cn/mmbiz_png/gH31uF9VIibQJxwib7BzC5KAqBOP9eibM8lm2lypCiaR3iabMbMS9dia3uAfPjXEpl4GP4wW89zZ6LLdyja0etrFWL2g/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/gH31uF9VIibQJxwib7BzC5KAqBOP9eibM8lcg7APC2jEot64RVfueTDic3fVzHqJMpicO499YaW8uM4ZWTdqBJPGjAg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
上一篇面试官：说说 React 生命周期有哪些不同阶段？每个阶段对应的方法是？下一篇面试官：说说对React的理解？有哪些特性？
